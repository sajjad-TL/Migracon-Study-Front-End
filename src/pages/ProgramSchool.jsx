      ...
      <div className="border-b shadow-sm bg-white">
        <div className="flex items-center justify-between px-4 py-2">
          <div className="flex items-center space-x-4">
            ...
            <span className="font-medium">Programs & Schools</span>
          </div>
          <div className="flex items-center space-x-4">
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center">
              ...
              <div className="relative">
                <select className="p-1 pr-6 border rounded-md text-sm appearance-none">
                  <option>Relevance</option>
                </select>
                <ChevronDown className="absolute right-1 top-2 text-gray-400" size={12} />
              </div>
            </div>
            ...
            <div key={index} className="bg-white rounded-lg border overflow-hidden">
              <div className="p-2 border-b">
                <div className="flex justify-between items-start mb-1">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="font-medium text-sm">{program.university}</h3>
                      <p className="text-xs text-gray-500">{program.location}</p>
                    </div>
                  </div>

                  {program.popular && (
                    <span className="bg-blue-500 text-white text-xs px-1.5 py-0.5 rounded">Popular</span>
                  )}

                  {program.highDemand && (
                    <span className="bg-green-500 text-white text-xs px-1.5 py-0.5 rounded">High Demand</span>
                  )}
                </div>

                <h2 className="text-base font-medium mb-0.5">{program.program}</h2>
              ...
              <div className="p-2 border-b grid grid-cols-2 gap-2">
                ...
                <div>
                  ...
                  <p className="font-medium text-sm">{program.applicationFee}</p>
                </div>
              </div>
              ...
              <div className="p-2 border-b">
                ...
                <div className="flex items-center">
                  <span className={`font-medium text-sm ${program.successRate === 'Very High' ? 'text-green-600' : 'text-yellow-600'}`}>
                    {program.successRate}
                  </span>
                </div>
              </div>
              ...
              <div className="p-2 border-b">
                <div className="flex space-x-2">
                  {program.intakes.map((intake, i) => (
                    <span key={i} className="text-xs text-gray-600">{intake}</span>
                  ))}
                </div>
              </div>
        ...
        <div className="flex justify-between items-center mt-4">
          <div className="flex items-center">
            ...
            <div className="relative">
              ...
              <ChevronDown className="absolute right-1 top-1.5 text-gray-400" size={10} />
            </div>
          </div>
